# BBMOD
Welcome to the official scripting API documentation of BBMOD 3.99.0-alpha2!
...
If you are a new user, see the [Tutorials](/bbmod/tutorials) section on the official website for guides on how to use
BBMOD.

/// @func bbmod_animate(animation_player, animation_instance, anim_time, interpolate_frames)
...
/// @param {bool} interpolate_frames True to interpolate between animation frames.
//var _t = get_timer();
...
var _interpolate_frames = argument3;

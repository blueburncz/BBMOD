...
if (keyboard_check(ord("X"))) layerShoot.Weight = clamp(layerShoot.Weight + _wheel, 0.0, 1.0);
if (keyboard_check(ord("C"))) layerJump.Weight = clamp(layerJump.Weight + _wheel, 0.0, 1.0);

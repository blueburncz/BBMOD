/// @func BBMOD_MixVec4FromSpeedModule([_property[, _from[, _to[, _min[, _max]]]]])
///
...
///
/// @see BBMOD_EParticle
function BBMOD_MixVec4FromSpeedModule(_property=undefined, _from=new BBMOD_Vec4(), _to=_from.Clone(), _min=0.0, _max=1.0)
	: BBMOD_ParticleModule() constructor
{
	...
	/// Default value is the same as {@link BBMOD_MixVec4FromSpeedModule.From}.
	To = _to;

	/// @var {Real} If the particles' speed is less than this, then the property
	/// is equal to {@link BBMOD_MixVec4FromSpeedModule.From}. Default value is 0.0.
	Min = _min;

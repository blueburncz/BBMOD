/// @func BBMOD_MixInitialVec2PropertyModule([_property[, _from[, _to[, _separate]]]])
///
/// @extends BBMOD_ParticleModule
///
/// @desc A universal particle module that randomly mixes initial values of
/// particles' two consecutive properties between two values.
///
...
///
/// @see BBMOD_EParticle
function BBMOD_MixInitialVec2PropertyModule(_property=undefined, _from=new BBMOD_Vec2(), _to=_from.Clone(), _separate=true)
	: BBMOD_ParticleModule() constructor
{
	...
	/// same as {@link BBMOD_MixInitialVec2PropertyModule.From}.
	To = _to;

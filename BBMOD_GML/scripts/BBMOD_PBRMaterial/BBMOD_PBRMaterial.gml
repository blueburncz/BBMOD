...
/// @macro {Struct.BBMOD_PBRMaterial} PBR material for animated models with bones.
/// @see BBMOD_PBRMaterial
#macro BBMOD_MATERIAL_PBR_ANIMATED __bbmod_material_pbr_animated()

/// @macro {Struct.BBMOD_PBRMaterial} PBR material for dynamically batched models.
/// @see BBMOD_PBRMaterial
/// @see BBMOD_DynamicBatch
	...
	: BBMOD_BaseMaterial(_shader) constructor
{
	...
	/// entire material.
	/// @param {Struct.BBMOD_Vec3} _normal The new normal vector. If you are not sure

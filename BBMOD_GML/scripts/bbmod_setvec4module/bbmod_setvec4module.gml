...
///
/// @see BBMOD_EParticle
function BBMOD_SetVec4Module(_property = undefined, _value = new BBMOD_Vec4()): BBMOD_ParticleModule() constructor
{
	...
	static from_buffer = function (_buffer)
	{
		...
		Value = new BBMOD_Vec4().FromBuffer(_buffer, buffer_f64);
		return self;
	};

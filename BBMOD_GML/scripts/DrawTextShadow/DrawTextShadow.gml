/// @func DrawTextShadow(_x, _y, _text[, _color[, _colorShadow]])
...
function DrawTextShadow(_x, _y, _text, _color=c_white, _colorShadow=c_black)
{
	gml_pragma("forceinline");
	draw_text_color(_x + 2, _y + 2, _text, _colorShadow, _colorShadow, _colorShadow, _colorShadow, 1);

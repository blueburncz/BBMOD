...
/// @macro {Struct.BBMOD_Shader} The default depth shader.
///
/// @example
...
/// @macro {Struct.BBMOD_Shader} Shader for rendering lightmapped models
/// with two UV channels.
...
/// @macro {Struct.BBMOD_Material} The default material.
#macro BBMOD_MATERIAL_DEFAULT __bbmod_material_default()

/// @macro {Struct.BBMOD_Material} The default material for unlit objects.
#macro BBMOD_MATERIAL_DEFAULT_UNLIT __bbmod_material_default_unlit()

/// @macro {Struct.BBMOD_Material} Material for lightmapped models with
/// two UV channels.
...
{
	static _shader = new BBMOD_Shader(BBMOD_ShStatic_Forward, BBMOD_VFORMAT_DEFAULT)
		.add_variant(BBMOD_ShAnimated_Forward, BBMOD_VFORMAT_DEFAULT_ANIMATED)
		.add_variant(BBMOD_ShBatched_Forward, BBMOD_VFORMAT_DEFAULT_BATCHED)
		.add_variant(BBMOD_ShStatic_VertexColors_Forward, BBMOD_VFORMAT_DEFAULT_COLOR)
		.add_variant(BBMOD_ShAnimated_VertexColors_Forward, BBMOD_VFORMAT_DEFAULT_COLOR_ANIMATED)
		.add_variant(BBMOD_ShBatched_VertexColors_Forward, BBMOD_VFORMAT_DEFAULT_COLOR_BATCHED)
		.add_variant(BBMOD_ShSprite_Forward, BBMOD_VFORMAT_DEFAULT_SPRITE);
	return _shader;
}

function __bbmod_shader_default_unlit()
{
	static _shader = new BBMOD_Shader(BBMOD_ShStatic_Unlit, BBMOD_VFORMAT_DEFAULT)
		.add_variant(BBMOD_ShAnimated_Unlit, BBMOD_VFORMAT_DEFAULT_ANIMATED)
		.add_variant(BBMOD_ShBatched_Unlit, BBMOD_VFORMAT_DEFAULT_BATCHED)
		.add_variant(BBMOD_ShStatic_VertexColors_Unlit, BBMOD_VFORMAT_DEFAULT_COLOR)
		.add_variant(BBMOD_ShAnimated_VertexColors_Unlit, BBMOD_VFORMAT_DEFAULT_COLOR_ANIMATED)
		.add_variant(BBMOD_ShBatched_VertexColors_Unlit, BBMOD_VFORMAT_DEFAULT_COLOR_BATCHED);
	return _shader;
}
...
function __bbmod_shader_default_lightmap()
{
	static _shader = new BBMOD_Shader(
		BBMOD_ShLightmapped_Forward, BBMOD_VFORMAT_DEFAULT_LIGHTMAP);
	return _shader;
}

function __bbmod_shader_default_depth()
{
	static _shader = new BBMOD_Shader(BBMOD_ShStatic_Depth, BBMOD_VFORMAT_DEFAULT)
		.add_variant(BBMOD_ShAnimated_Depth, BBMOD_VFORMAT_DEFAULT_ANIMATED)
		.add_variant(BBMOD_ShBatched_Depth, BBMOD_VFORMAT_DEFAULT_BATCHED)
		.add_variant(BBMOD_ShLightmapped_Depth, BBMOD_VFORMAT_DEFAULT_LIGHTMAP)
		.add_variant(BBMOD_ShStatic_VertexColors_Depth, BBMOD_VFORMAT_DEFAULT_COLOR)
		.add_variant(BBMOD_ShAnimated_VertexColors_Depth, BBMOD_VFORMAT_DEFAULT_COLOR_ANIMATED)
		.add_variant(BBMOD_ShBatched_VertexColors_Depth, BBMOD_VFORMAT_DEFAULT_COLOR_BATCHED)
		.add_variant(BBMOD_ShSprite_Depth, BBMOD_VFORMAT_DEFAULT_SPRITE);
	return _shader;
}
...
function __bbmod_material_default()
{
	...
	{
		_material = new BBMOD_Material(BBMOD_SHADER_DEFAULT);
...
function __bbmod_material_default_unlit()
{
	...
	if (_material == undefined)
	{
		_material = new BBMOD_Material(BBMOD_SHADER_DEFAULT_UNLIT);
		_material.Persistent = true;
		_material.BaseOpacity = sprite_get_texture(BBMOD_SprWhite, 0);
	}
	return _material;
...
function __bbmod_material_default_lightmap()
{
	...
	if (_material == undefined)
	{
		_material = new BBMOD_Material(BBMOD_SHADER_DEFAULT_LIGHTMAP);
		_material.Persistent = true;
	}
	return _material;
}
...
function __bbmod_material_default_sprite()
{
	...
	if (_material == undefined)
	{
		_material = new BBMOD_Material(BBMOD_SHADER_DEFAULT_SPRITE);
		_material.Persistent = true;
	}
	return _material;
}
...
/// @macro {Struct.BBMOD_Shader} Shader for 2D sprites.
...
/// @macro {Struct.BBMOD_Shader} Depth shader for static models.
/// @deprecated Please use {@link BBMOD_SHADER_DEFAULT_DEPTH} instead.
#macro BBMOD_SHADER_DEPTH BBMOD_SHADER_DEFAULT_DEPTH

/// @macro {Struct.BBMOD_Shader} Depth shader for animated models with bones.
/// @deprecated Please use {@link BBMOD_SHADER_DEFAULT_DEPTH} instead.
#macro BBMOD_SHADER_DEPTH_ANIMATED BBMOD_SHADER_DEFAULT_DEPTH

/// @macro {Struct.BBMOD_Shader} Depth shader for dynamically batched models.
/// @deprecated Please use {@link BBMOD_SHADER_DEFAULT_DEPTH} instead.
#macro BBMOD_SHADER_DEPTH_BATCHED BBMOD_SHADER_DEFAULT_DEPTH

/// @macro {Struct.BBMOD_Shader} Depth shader for lightmapped models with
/// two UV channels.
/// @deprecated Please use {@link BBMOD_SHADER_DEFAULT_DEPTH} instead.

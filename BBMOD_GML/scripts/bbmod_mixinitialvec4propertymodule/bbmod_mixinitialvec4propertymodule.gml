/// @func BBMOD_MixInitialVec4PropertyModule([_property[, _from[, _to[, _separate]]]])
///
/// @extends BBMOD_ParticleModule
///
/// @desc A universal particle module that randomly mixes initial values of
/// particles' four consecutive properties between two values.
///
...
///
/// @see BBMOD_EParticle
function BBMOD_MixInitialVec4PropertyModule(_property=undefined, _from=new BBMOD_Vec4(), _to=_from.Clone(), _separate=true)
	: BBMOD_ParticleModule() constructor
{
	...
	/// same as {@link BBMOD_MixInitialVec4PropertyModule.From}.
	To = _to;

...
/// @param {Struct.BBMOD_Vec2} [_change] The value to add to particles' health. Defaults
/// to `(1.0, 1.0)`.
///
/// @see BBMOD_EParticle.HasCollided
function BBMOD_AddVec2OnCollisionModule(_property=undefined, _change=new BBMOD_Vec2(1.0))

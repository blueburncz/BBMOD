/// @func BBMOD_MixVec2FromSpeedModule([_property[, _from[, _to[, _min[, _max]]]]])
///
...
///
/// @see BBMOD_EParticle
function BBMOD_MixVec2FromSpeedModule(_property=undefined, _from=new BBMOD_Vec2(), _to=_from.Clone(), _min=0.0, _max=1.0)
	: BBMOD_ParticleModule() constructor
{
	...
	/// Default value is the same as {@link BBMOD_MixVec2FromSpeedModule.From}.
	To = _to;

	/// @var {Real} If the particles' speed is less than this, then the property
	/// is equal to {@link BBMOD_MixVec2FromSpeedModule.From}. Default value is 0.0.
	Min = _min;

	/// @var {Real} If the particles' speed is greater than this, then the property
	/// is equal to {@link BBMOD_MixVec2FromSpeedModule.To}. Default value is 1.0.
	Max = _max;

...
function BBMOD_Vec4(_x=0.0, _y=undefined, _z=undefined, _w=undefined) constructor
{
	...
	/// @param {BBMOD_Vec4} _v The other vector.
	/// @return {BBMOD_Vec4} The created vector.
	...
	/// @return {BBMOD_Vec4} The creted vector.
	...
	/// @param {BBMOD_Vec4} _dest The destination vector.
	...
	/// @param {BBMOD_Vec4} _v The vector to compare to.
	...
	/// @param {BBMOD_Vec4} _v1 The first point of a triangle.
	/// @param {BBMOD_Vec4} _v2 The second point of a triangle.
	/// @param {BBMOD_Vec4} _v3 The third point of a triangle.
	...
	/// @param {BBMOD_Vec4} _v The vector to interpolate with.
	...
	/// as a new vector.
	/// @param {BBMOD_Vec4} _v The vector to reflect from.
	/// @return {BBMOD_Vec4} The created vector.
	...
	/// as a new vector.
	/// @param {BBMOD_Vec4} _v The vector to subtract from this one.
	/// @return {BBMOD_Vec4} The created vector.
	/// @example
	/// ```gml
	/// var _v1 = new BBMOD_Vec4(1.0, 2.0, 3.0, 4.0);

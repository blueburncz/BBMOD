/// @func BBMOD_SpriteDefaultShader(_shader, _vertexFormat)
/// @extends BBMOD_DefaultShader
/// @desc A default shader that can be used when rendering GameMaker sprites.
...
function BBMOD_SpriteDefaultShader(_shader, _vertexFormat)

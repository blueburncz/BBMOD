...
/// @macro {Struct.BBMOD_Shader} A shader used when rendering instance IDs.
///
/// @example
/// ```gml
...
{
	static _shader = new BBMOD_Shader(BBMOD_ShStatic_InstanceID, BBMOD_VFORMAT_DEFAULT)
		...
		.add_variant(BBMOD_ShStatic_VertexColors_InstanceID, BBMOD_VFORMAT_DEFAULT_COLOR)
		.add_variant(BBMOD_ShAnimated_VertexColors_InstanceID, BBMOD_VFORMAT_DEFAULT_COLOR_ANIMATED)
		.add_variant(BBMOD_ShBatched_VertexColors_InstanceID, BBMOD_VFORMAT_DEFAULT_COLOR_BATCHED)

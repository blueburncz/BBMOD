...
): BBMOD_PostProcessEffect() constructor
{
	...
	static __uLightPos = shader_get_uniform(BBMOD_ShSunShaftMask, "uLightPos");
	static __uAspect = shader_get_uniform(BBMOD_ShSunShaftMask, "uAspect");
	static __uMaskRadius = shader_get_uniform(BBMOD_ShSunShaftMask, "uRadius");
	static __uColor = shader_get_uniform(BBMOD_ShSunShaftMask, "uColor");

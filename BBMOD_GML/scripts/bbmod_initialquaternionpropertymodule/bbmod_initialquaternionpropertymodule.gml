/// @func BBMOD_InitialQuaternionPropertyModule(_property, _value)
///
...
///
/// @see BBMOD_EParticle
function BBMOD_InitialQuaternionPropertyModule(_property=undefined, _value=new BBMOD_Quaternion())

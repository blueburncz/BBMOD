	...
	: BBMOD_ParticleModule() constructor
{
	...
	/// {@link BBMOD_MixQuaternionFromSpeedModule.From}.
	To = _to;

	/// @var {Real} If the particles' speed is less than this, then the property
	/// is equal to {@link BBMOD_MixQuaternionFromSpeedModule.From}. Default value is 0.0.
	Min = _min;

	/// @var {Real} If the particles' speed is greater than this, then the property
	/// is equal to {@link BBMOD_MixQuaternionFromSpeedModule.To}. Default value is 1.0.
	Max = _max;

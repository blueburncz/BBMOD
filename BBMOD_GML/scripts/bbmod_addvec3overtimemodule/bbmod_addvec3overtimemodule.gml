...
function BBMOD_AddVec3OverTimeModule(_property=undefined, _change=new BBMOD_Vec3(1.0), _period=1.0)
	: BBMOD_ParticleModule() constructor
{
	/// @var {Enum.BBMOD_EParticle/undefined} The first of the three

/// @func BBMOD_MixVec3FromHealthModule([_property[, _from[, _to]]])
///
...
///
/// @see BBMOD_EParticle
function BBMOD_MixVec3FromHealthModule(_property=undefined, _from=new BBMOD_Vec3(), _to=_from.Clone())
	: BBMOD_ParticleModule() constructor
{
	...
	/// value is the same as {@link BBMOD_MixVec3FromHealthModule.From}.
	To = _to;

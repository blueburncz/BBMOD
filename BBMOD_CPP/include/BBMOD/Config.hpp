...
/// A value used to tell that flat normals should be generated if the model
/// doesn't have any.
#define BBMOD_NORMALS_FLAT 1

/// A value used to tell that smooth normals should be generated if the model
/// doesn't have any.
...
struct SConfig
{
	...
	/// Disable saving vertex normals. This also automatically disable tangent
	/// vector and bitangent sign.
